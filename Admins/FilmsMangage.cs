...
static class FilmsManage
{
    ...
    public static Film? GetFilmInfo()
    {
        ...
        while (true)
        {
            Console.WriteLine("vul in de film prijs in euro's: Om te stoppen houdt deze lijn leeg");
        ...
        while (true)
        {
            Console.WriteLine($"vul het Jaar van uitgave in: Om te stoppen houdt deze lijn leeg");
        ...
        while (true)
        {
            Console.WriteLine("vul de regisseur van de film in: Om te stoppen houdt deze lijn leeg");
